...
###############################
# SSM policy
# Required for Systems Manager access (EC2 Instance Connect, Session Manager)
# Allows nodes to register with SSM and be managed remotely
###############################
...
resource "aws_iam_policy" "ssm" {
  name   = format("vcluster-ssm-%s", random_id.suffix.hex)
